...
// Example: Modify your piece move logic to include the sound
function movePiece(piece, targetCell) {
    // Assuming your piece movement logic is here
    const currentCell = piece.parentNode; // Get the current cell of the piece
    ...
    // Update game state (e.g., turn, possible moves, etc.)
    updateGameState();
}

// Example: Add event listeners for pieces
document.querySelectorAll('.piece').forEach(piece => {
    piece.addEventListener('click', () => {
        // Call the movePiece function with your logic
        const targetCell = document.querySelector('#someTargetCell'); // Replace with your target logic
